                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="user_replensih" autocomplete="on" method = "POST">
                                <h1><fmt:message key="paymentForm.title" /></h1>
                               <p>
                                    <label for="cardnumberfrom" class="uname"><fmt:message key="paymentForm.from" /></label>
								 ...
								 <p>
                                    <label for="cardnumberto" class="uname"><fmt:message key="paymentForm.to" /></label>
